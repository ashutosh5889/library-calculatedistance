package com.aiims.aasys.mainactivity;
...
import com.aiims.aasys.mylib.LatLonDistanceCalculator;
import com.aiims.aasys.mylib.Point;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView kilometersLabel = (TextView) findViewById(R.id.km);
